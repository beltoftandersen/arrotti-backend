...
// GET /admin/collections/:collection_id/seo
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  try {
    const collection = await productService.retrieveProductCollection(collection_id, {
      select: ["id", "metadata"],
    })
...
// POST /admin/collections/:collection_id/seo
export async function POST(req: MedusaRequest<SeoBody>, res: MedusaResponse) {
  ...
  try {
    ...
    const currentMetadata = (collection.metadata || {}) as Record<string, unknown>
    ...
    // Update collection
    await productService.updateProductCollections(collection_id, {
