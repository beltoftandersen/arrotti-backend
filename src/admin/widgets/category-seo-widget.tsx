...
const CategorySeoWidget = () => {
  ...
  const loadSeo = async () => {
    ...
    try {
      const response = await fetch(`/admin/categories/${categoryId}/seo`, {
        credentials: "include",
      })
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <Text size="xsmall" className="text-ui-fg-subtle mt-1">
                Overrides the category name in search results
              </Text>
            </div>
            ...
            <div>
              ...
              <Input
                ...
                placeholder="brake pads, rotors, suspension, automotive"
              />
              <Text size="xsmall" className="text-ui-fg-subtle mt-1">
